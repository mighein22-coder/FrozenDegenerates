...
--
-- 0003 hides other players' picks before the deadline. This closes the other
-- half of the same hole: it stops anyone changing their own picks after it.
-- The two are complementary; applying only 0003 leaves late edits possible.
--
...
--
-- Depends on picks_revealed() from 0003. Apply 0003 first.
